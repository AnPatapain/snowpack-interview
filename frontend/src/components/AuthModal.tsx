    ...
    return (
        <div className="max-w-md p-4 bg-slate-400 border-solid rounded-lg">
            ...
            <form className="max-w-sm flex flex-col mx-auto my-2" onSubmit={handleSubmit}>
                ...
                {loading ? <button className="btn btn-success text-xl my-8" disabled={true}>Loading...</button> :
                    <button className="btn btn-success text-xl my-8" onClick={handleSubmit}>{isSignup ? 'Continue' : 'Login'}</button>
                }
